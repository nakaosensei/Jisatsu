...
class Plant:
    ...
    def toDatabaseFormat(self):
        return (self.nome,self.autor,self.fonte,self.estado,self.grupoTaxonomico,self.familia,self.formaVida,self.substrato,self.origem,self.endemismo,self.ocorrenciasConfirmadas,self.ocorrenciasPossiveis,self.dominiosFitogeograficos,self.tipoVegetacao,self.plantaOriginal)
